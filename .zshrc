...
export ZSH="/home/chicken/.oh-my-zsh"
...
alias serve='browser-sync start --server --files '# Set defaults
alias du='ncdu --color dark -rr -x --exclude .git --exclude node_modules'
alias wgu='systemctl start wg-quick@wg0'
alias wgd='systemctl stop wg-quick@wg0'
